    ...
    "lecons": [
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définitions",
              "contenu": "La civilité est le savoir-vivre en société. C'est aussi le respect de la courtoisie et des règles de bienséance en groupe. Faire preuve de civilité, c'est être poli et respectueux envers les autres."
            },
            {
              "titre": "2. Les règles de bienséance",
              "contenu": "Ce sont des comportements qui montrent que vous êtes des personnes bien éduquées."
            },
            {
              "titre": "2-1. À la maison",
              "contenu": "Je décharge ma mère qui revient du marché ; je me lave les mains avant de manger ; je lave mes mains au sortir du WC ; j'aide ma mère à la cuisine ; je dois respecter mes parents ; je dois aider mes parents dans les travaux domestiques et champêtres."
            },
            {
              "titre": "2-2. À l'école",
              "contenu": "Je salue poliment mes enseignants ; j'aide mes camarades à résoudre un problème ; j'évite de manger en classe ; je sors de la classe avant de lâcher ; je dois respecter le règlement intérieur ; je ne dois pas bavarder en classe."
            },
            {
              "titre": "2-3. En groupe",
              "contenu": "J'arrête le jeu lorsqu'il devient violent ; je baisse la tête ou je me couvre la bouche avant de tousser ; je demande d'abord la parole avant de parler ; je dois éviter de juger les autres."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définition",
              "contenu": "Les formules de courtoisie sont des formules écrites ou orales qui servent le plus souvent à commencer ou à terminer une conversation ou une lettre de façon polie."
            },
            {
              "titre": "2. Les formules de politesse",
              "contenu": "Ce sont l'ensemble des règles de savoir-vivre en usage dans une société. Exemples : « J'ai l'honneur de solliciter de votre bienveillance », « Veuillez agréer, Monsieur/Madame, l'expression de ma profonde gratitude », « Recevez, Monsieur/Madame, mes sincères salutations »."
            },
            {
              "titre": "3. Les formules de salutation",
              "contenu": "En famille ou avec des camarades : « Bonjour papa/maman/ma tante/mes camarades », « Bonne arrivée ». Avec une autorité : « Bonjour Monsieur/Honorable/Excellence », « Recevez, Monsieur, mes salutations distinguées »."
            },
            {
              "titre": "4. Les formules de demande d'aide et d'excuse",
              "contenu": "Pour demander de l'aide : « S'il te plaît papa/maman » en famille, ou « Pourriez-vous... », « Veuillez m'autoriser à... » avec une autorité. Pour s'excuser : « Toutes mes excuses » en famille, ou « Je vous prie de bien vouloir accepter toutes mes excuses » avec une autorité."
            }
          ],
      ...
      },
      {
        ...
        "titre": "IMC et son interprétation",
        "seances": 2,
        "fiche": {
          "competence": "S'apprécier et apprécier les autres",
          "theme": "Connaissance de soi et des autres",
          ...
          "resumeStructure": [
            {
              ...
              "contenu": "L'IMC (Indice de Masse Corporelle) permet d'évaluer la corpulence d'une personne à partir de sa taille et de son poids. Il se calcule pour les personnes dont l'âge est compris entre 18 et 65 ans."
            },
            {
              "titre": "2. Mesure de la taille et relevé du poids",
              "contenu": "La taille est la hauteur du corps d'une personne ; elle se mesure en mètres à l'aide d'une toise ou d'un mètre ruban (exemple : 1,78 m). Le poids est la masse du corps ; il se relève en kilogrammes à l'aide d'un pèse-personne (exemple : 69 kg)."
            },
            {
              "titre": "3. Calcul de l'IMC",
              "contenu": "Pour calculer l'IMC, on utilise la formule de Quetelet : IMC = Poids (kg) ÷ [Taille (m) × Taille (m)]. Exemple : pour un poids de 69 kg et une taille de 1,78 m, l'IMC est d'environ 21,8."
            },
            {
              "titre": "4. Interprétation de l'IMC (grille de l'OMS)",
              "contenu": "L'Organisation Mondiale de la Santé a établi les seuils suivants : IMC inférieur à 18,5 = maigreur ; entre 18,5 et 25 = corpulence normale ; entre 25 et 30 = surpoids ; entre 30 et 40 = obésité modérée ; supérieur à 40 = obésité morbide."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Le surpoids",
              "contenu": "Le surpoids est une accumulation anormale de graisse qui nuit à la santé. Une personne est en surpoids lorsque son IMC est compris entre 25 et 30. Ses inconvénients sont notamment l'essoufflement rapide à l'effort, le ronflement pendant le sommeil et une respiration bruyante."
            },
            {
              "titre": "2. L'obésité",
              "contenu": "L'obésité est une accumulation excessive de graisse qui nuit à la santé. Une personne est obèse lorsque son IMC est supérieur à 30. C'est une maladie qui entraîne des conséquences graves : hypertension artérielle, AVC, diabète, cancer, arthrose, infertilité et fausses couches chez les femmes."
            },
            {
              "titre": "3. Conseils pour éviter le surpoids et l'obésité",
              "contenu": "Il faut faire du sport régulièrement, manger moins gras et moins sucré, et manger davantage de fruits et de légumes."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Les qualités et les défauts",
              "contenu": "Les qualités d'une personne sont ses bons caractères (forces) : par exemple être bon, dynamique, respectueux, patient, honnête, généreux, humble, créatif, courageux. Les défauts sont ses mauvais comportements (faiblesses) : par exemple être violent, égoïste, irrespectueux, malhonnête, orgueilleux, paresseux, peureux, coléreux."
            },
            {
              "titre": "2. Les talents",
              "contenu": "Les talents d'une personne sont ses aptitudes, ce qu'elle sait bien faire, une caractéristique propre qui se développe au fil de son parcours. Exemples : être excellent en football, savoir bricoler les appareils, être habile en négociation, être excellent en dessin."
            },
            {
              "titre": "3. Les centres d'intérêt",
              "contenu": "Ce sont toutes les activités qu'une personne aime particulièrement faire. Exemples : le sport, le bricolage, la pratique d'un instrument de musique, s'occuper des animaux, le voyage, les mathématiques."
            },
            {
              "titre": "4. Le métier d'avenir",
              "contenu": "Un métier d'avenir est un métier dont on rêve depuis l'enfance de faire plus tard. Exemples : professeur, athlète, footballeur professionnel, docteur, ingénieur en cybersécurité, éleveur, styliste, commerçant."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Les parents directs",
              "contenu": "C'est le lien qui existe entre deux personnes dont l'une descend de l'autre : mon père (l'homme qui m'a donné la vie), ma mère (la femme qui m'a donné la vie), mon grand-père et ma grand-mère (parents de mon père ou de ma mère), mon arrière-grand-père et mon arrière-grand-mère."
            },
            {
              "titre": "2. Les parents proches",
              "contenu": "Ce sont les personnes avec qui j'ai un lien de parenté direct au-delà des parents directs : ma tante (petite sœur de mon père ou de ma mère), mon oncle (frère de mon père ou de ma mère), ma cousine, mon cousin, mon demi-frère, ma demi-sœur."
            },
            {
              "titre": "3. Les parents éloignés (par alliance)",
              "contenu": "Mon beau-frère (frère de mon mari ou de ma femme), mon beau-père et ma belle-mère (parents de mon époux/épouse), ma belle-sœur (femme de mon frère), ma bru (femme de mon fils), mon gendre (mari de ma fille)."
            }
          ],
      ...
      },
      {
        ...
        "competence": "S'apprécier et apprécier les autres",
        "theme": "Connaissance de soi et des autres",
        "titre": "Fondements, fonctions et gestion de la famille",
        "seances": 2,
        "fiche": {
          "competence": "S'apprécier et apprécier les autres",
          "theme": "Connaissance de soi et des autres",
          ...
          "resumeStructure": [
            {
              "titre": "1. Les fondements de la famille",
              "contenu": "Dans une famille, les parents doivent avoir un lien de mariage et faire régner certains fondements : l'amour, le dialogue, la confiance, la fidélité, la foi, la joie, la paix, l'entraide, la solidarité, la bonne gestion des biens, le calme et la prospérité."
            },
            {
              "titre": "2. Les fonctions de la famille",
              "contenu": "Ce sont : donner naissance aux enfants, les soigner, les éduquer, avoir des ressources financières, s'entraider et s'aimer les uns les autres. Les enfants participent aussi par les travaux champêtres, le balayage, la vaisselle ou le puisage de l'eau."
            },
            {
              "titre": "3. La bonne gestion de la famille",
              "contenu": "Pour une bonne gestion de ma famille, je dois participer à la bonne gestion des ressources (eau, lumière, argent de poche, nourriture), accomplir mes tâches domestiques, créer un bon courant de communication entre les membres de ma famille, et être un instrument de paix et de dialogue."
            }
          ],
      ...
      },
      {
        ...
        "titre": "Description et utilité de la maison",
        "seances": 2,
        "fiche": {
          "competence": "Protéger son cadre de vie",
          "theme": "Connaissance de son cadre de vie",
          ...
          "resumeStructure": [
            {
              "titre": "1. Définition de la maison",
              "contenu": "Une maison est un bâtiment construit pour servir d'habitation aux personnes. C'est le lieu où nous habitons et dormons."
            },
            {
              "titre": "2. Description d'une maison",
              "contenu": "Une maison peut être entourée d'un mur appelé clôture. On y trouve différentes pièces : le garage, la cuisine, la véranda, le salon, les chambres à coucher, la douche, les toilettes. Le salon et les chambres contiennent des meubles et des appareils électriques."
            },
            {
              "titre": "3. Utilité de la maison",
              "contenu": "Une maison est le lieu de résidence d'une famille ; elle protège du regard des autres et des intempéries ; elle assure la sécurité de la famille ; elle abrite les biens de la famille ; elle constitue une richesse familiale et un lieu de repos."
            },
            {
              "titre": "4. Entretien de la maison",
              "contenu": "La maison est un patrimoine familial que tous les membres doivent entretenir : la protéger contre le vol et le vandalisme, la nettoyer régulièrement (balayage, évacuation des eaux usées), protéger les fosses septiques, prendre soin des animaux domestiques et ranger les biens."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Protéger son cadre de vie",
        "theme": "Connaissance de son cadre de vie",
        "titre": "Accidents domestiques et précautions à prendre",
        "seances": 2,
        "fiche": {
          "competence": "Protéger son cadre de vie",
          "theme": "Connaissance de son cadre de vie",
          ...
          "resumeStructure": [
            {
              "titre": "1. Définition d'un accident domestique",
              "contenu": "Un accident domestique est un accident qui se produit à la maison."
            },
            {
              "titre": "2. Les différents accidents domestiques",
              "contenu": "Ce sont les chutes, les brûlures, les blessures, les intoxications dues aux médicaments ou aux aliments, l'électrocution, les incendies et les noyades."
            },
            {
              "titre": "3. Les précautions à prendre",
              "contenu": "Pour éviter les accidents domestiques, je dois : ranger les objets tranchants et pointus hors de portée des enfants, enlever les câbles électriques du sol, bien fermer le gaz après usage, éteindre le feu après utilisation, éviter l'automédication, faire vérifier les installations par un spécialiste, disposer d'un extincteur à la maison, et disjoncter le compteur en cas d'électrocution."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Le collège et ses changements par rapport au primaire",
              "contenu": "Le collège est un établissement public du premier cycle du secondaire. Il accueille les élèves titulaires du CEPD (Certificat d'Étude du Premier Degré), âgés de dix ans révolus, pour une durée réglementaire de quatre ans. Les changements par rapport au primaire concernent le corps d'encadrement, la tenue, les horaires et les évaluations."
            },
            {
              "titre": "2. Le corps d'encadrement du collège",
              "contenu": "Le personnel administratif comprend le Directeur (chef d'établissement), le Directeur-Adjoint (Directeur des Études), le Conseiller Principal d'Éducation ou Surveillant Général (discipline), le ou les Secrétaires, l'Économe et le Bibliothécaire. Le personnel enseignant regroupe tous les enseignants ; chaque classe a un enseignant titulaire qui joue le rôle de tuteur."
            },
            {
              "titre": "3. La tenue et les horaires",
              "contenu": "Tout apprenant doit porter l'uniforme de son établissement (au Togo : pantalon et chemise kaki pour les garçons, jupe kaki et corsage blanc pour les filles). Le collège fonctionne du lundi au vendredi, avec la montée des couleurs à 6h45, sept heures de cours le matin et l'après-midi."
            },
            {
              "titre": "4. Les évaluations et les bonnes relations entre élèves",
              "contenu": "L'enseignement au collège dure 4 ans et est sanctionné par le BEPC. Les évaluations comprennent les interrogations, les Devoirs Sur Table (DST) et les compositions régionales. Entre élèves, il faut cultiver la bonne camaraderie, l'amitié, la complémentarité et l'acceptation des différences (niveau, ethnie, religion)."
            }
          ],
      ...
      },
      {
        ...
        "titre": "Comprendre l'extrémisme violent",
        "seances": 2,
        "fiche": {
          "competence": "Promouvoir les idéaux de paix et de non-violence",
          "theme": "Extrémisme violent et culture de la paix",
          ...
          "resumeStructure": [
            {
              ...
              "contenu": "L'extrémisme violent est une idéologie radicale qui prône l'utilisation de la violence pour atteindre des objectifs politiques, religieux ou idéologiques."
            },
            {
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définitions",
              "contenu": "La paix est un état de tranquillité et de calme ; c'est aussi l'absence de guerre, la lutte contre la violence, et le fait d'être apaisé en soi-même et d'entretenir de bonnes relations avec les autres. La culture de la paix est un ensemble de comportements qui rejettent la violence."
            },
            {
              "titre": "2. Les différents types de paix",
              "contenu": "Il en existe plusieurs : la paix intérieure (avec soi-même), la paix avec les autres, la paix avec son environnement, la paix nationale et internationale, ainsi que la paix sociale."
            },
            {
              "titre": "3. Œuvres de la guerre et œuvres de la paix",
              "contenu": "La guerre entraîne pertes en vies humaines, blessés, destruction des infrastructures, pauvreté accrue et destruction de l'environnement. La paix, elle, favorise la solidarité, la cohésion sociale, l'harmonie, le respect des droits humains, le vivre-ensemble, le développement économique et social, et la protection de l'environnement."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Promouvoir les idéaux de paix et de non-violence",
        "theme": "Extrémisme violent et culture de la paix",
        "titre": "Paix avec soi-même et avec les autres",
        "seances": 2,
        "fiche": {
          "competence": "Promouvoir les idéaux de paix et de non-violence",
          "theme": "Extrémisme violent et culture de la paix",
          ...
          "resumeStructure": [
            {
              "titre": "1. La paix avec soi-même : définition",
              "contenu": "Être en paix avec soi-même, c'est aimer qui on est et se faire du bien ; c'est se sentir bien dans sa peau."
            },
            {
              "titre": "2. Comment être en paix avec soi-même",
              "contenu": "Ma paix vient de mon cœur et de mon âme. Je serai en paix avec moi-même si je me pardonne mes fautes, si je ne me compare pas aux autres, si j'arrête de me plaindre, si je valorise mes qualités et mes talents, et si je m'encourage dans les moments difficiles."
            },
            {
              "titre": "3. La paix avec les autres : définition",
              "contenu": "La paix avec les autres, c'est entretenir de bonnes relations avec son entourage (amis, camarades, parents, quartier, école) ; c'est vivre en harmonie et développer le vivre-ensemble."
            },
            {
              "titre": "4. Comment être en paix avec les autres",
              "contenu": "Il faut d'abord être en paix avec soi-même, écouter attentivement les autres, éviter d'être en colère et de crier, pardonner aux autres, éviter de toujours vouloir avoir raison, et participer aux travaux communautaires."
            }
          ],
      ...
      },
      {
        ...
        "titre": "Conservation et protection des aliments",
        "seances": 2,
        "fiche": {
          "competence": "Adopter des règles d'hygiène et prendre soin de son environnement",
          "theme": "Santé, environnement",
          ...
          "resumeStructure": [
            {
              "titre": "1. La conservation des aliments",
              "contenu": "Les aliments sont toutes les substances qui servent à la nutrition des êtres vivants. On les conserve pour préserver leur comestibilité et leurs propriétés nutritives, éviter qu'ils se gâtent et éviter le gaspillage."
            },
            {
              "titre": "2. Les méthodes de conservation",
              "contenu": "On peut citer : la conservation par la chaleur, le boucanage ou fumage, le séchage, la salaison, la réfrigération ou congélation, la cuisson à l'eau ou la friture."
            },
            {
              "titre": "3. La protection des aliments",
              "contenu": "On protège les aliments pour éviter leur contamination par les parasites et leur destruction par les animaux ; les aliments non protégés sont souvent source de maladies comme la diarrhée ou le choléra."
            },
            {
              "titre": "4. Les méthodes de protection",
              "contenu": "Il faut bien couvrir les plats avec des couvercles, bien fermer les marmites, mettre les aliments au frigo ou dans un garde-manger fermé, couvrir les marmites avec un torchon propre, et garder la cuisine propre en éloignant les insectes."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Adopter des règles d'hygiène et prendre soin de son environnement",
        "theme": "Santé, environnement",
        "titre": "Comité d'hygiène de l'établissement",
        "seances": 2,
        "fiche": {
          "competence": "Adopter des règles d'hygiène et prendre soin de son environnement",
          "theme": "Santé, environnement",
          ...
          "resumeStructure": [
            {
              "titre": "1. Composition du comité d'hygiène de l'établissement",
              "contenu": "Le comité d'hygiène se compose de cinq membres : le surveillant, un enseignant, deux représentants d'élèves (un garçon et une fille) et le responsable des vendeurs."
            },
            {
              "titre": "2. Rôle du comité d'hygiène",
              "contenu": "Son rôle est de s'assurer que les élèves mangent des aliments de bonne qualité au sein de l'établissement."
            },
            {
              "titre": "3. Activités du comité d'hygiène",
              "contenu": "Vérifier que les carnets de santé des vendeurs sont à jour, contrôler la propreté des vendeurs et la qualité de la nourriture, recueillir les problèmes et plaintes des élèves, et les transmettre au chef d'établissement pour décision."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Adopter des règles d'hygiène et prendre soin de son environnement",
        "theme": "Santé, environnement",
        "titre": "Entretien de l'environnement immédiat",
        "seances": 2,
        "fiche": {
          "competence": "Adopter des règles d'hygiène et prendre soin de son environnement",
          "theme": "Santé, environnement",
          ...
          "resumeStructure": [
            {
              "titre": "1. Définition",
              "contenu": "L'environnement immédiat est le lieu de vie habituelle d'un individu : maison, école, marché, quartier, service ou village."
            },
            {
              "titre": "2. Le droit à un environnement sain",
              "contenu": "Un environnement sain est un environnement propre, non pollué. L'élève a droit à un cadre de vie propre pour bien étudier ; cette propreté permet d'être en bonne santé et d'éviter les maladies."
            },
            {
              "titre": "3. Comment entretenir son environnement immédiat",
              "contenu": "Je dois balayer régulièrement mon environnement, nettoyer les douches et les WC, évacuer les eaux usées, participer régulièrement au nettoyage (sarclage), et mettre en place des poubelles pour les déchets."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définitions",
              "contenu": "Un jardin est un lieu aménagé où l'on cultive des plantes domestiques ou sélectionnées. Un parterre est une bande de terre plantée de fleurs ou de gazon devant ou autour d'un bâtiment."
            },
            {
              "titre": "2. Les différents types de jardins",
              "contenu": "Selon les types de plantes, on distingue le jardin potager, le jardin de fleurs, le jardin d'arbres et le jardin d'arbres fruitiers (verger)."
            },
            {
              "titre": "3. Utilités des jardins et parterres",
              "contenu": "Ils sont des lieux de rencontre et de repos, des espaces de jeu et d'apprentissage, des espaces nourriciers qui embellissent l'environnement ; ils protègent aussi le sol et purifient l'air."
            },
            {
              "titre": "4. Comment protéger les jardins et parterres",
              "contenu": "Il faut les arroser régulièrement, enlever les mauvaises herbes, les tailler et les élaguer, et éviter d'en faire des dépotoirs."
            }
          ],
    ...
    "lecons": [
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "DÉFINITIONS",
              "contenu": "Le civisme: c’est le dévouement du citoyen pour son pays ou sa collectivité. L'incivisme : c'est le manque de dévouement du citoyen pour le bien de la nation. Avoir le sens civique : c'est respecter la loi et protéger le bien public .... Poser des actes inciviques : c’est poser des actes contraires au civisme. C’est aussi poser de mauvais actes. Exemples : violer les feux tricolores, marcher lorsqu'on monte les couleurs, jeter les sachets plastiques sur la cour ou dans la classe, faire du bruit ou bavarder au cours de la leçon...."
            },
            {
              "titre": "Amour de la patrie : c'est être fier de son pays",
              "contenu": "Engagement pour la patrie : C'est défendre corps et âme son pays. Vivre ensemble: c'est défendre la cohésion de la nation, respecter les règles de bienséance. Exemples: être tolérant, dire non au tribalisme, à l'ethnocentrisme, éviter de faire du bruit aux heures de repos, ne pas bavarder et distraire ses camarades en classe..."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Adopter des comportements civiques",
        "theme": "Civisme",
        "titre": "Comportements civiques et inciviques",
        "seances": 2,
        "fiche": {
          "competence": "Adopter des comportements civiques",
          "theme": "Civisme",
          ...
          "resumeStructure": [
            {
              "titre": "LES COMPORTEMENTS INCIVIQUES AU QUOTIDIEN",
              "contenu": "Un comportement incivique est un comportement de mépris vis – à vis de la loi et du respect de la chose publique. Dans la rue . - jeter les ordures dans la rue - ne pas aider les personnes âgées ou handicapées - être ivre - ne pas respecter les panneaux de signalisation - détruire les biens publics Dans le quartier . - injurier les gens du quartier - sauter les murs - voler - créer des dépotoirs sauvages - non assistance aux personnes en danger."
            },
            {
              "titre": "LES COMPORTEMENTS CIVIQUES AU QUOTIDIEN",
              "contenu": "Un comportement civique est un comportement de respect de la loi et de protection du bien public. A l'école . - respecter le règlement intérieur - assister à la montée des couleurs - bien chanter l'hymne national - respecter les enseignants - ne pas bavarder aux heures de cours - balayer la salle de classe - ne pas détruire les matériels scolaires… Dans la rue . - ne pas jeter les ordures dans la rue - aider les personnes âgées et handicapées - éviter l'alcool - respecter les panneaux de signalisation - protéger les biens publics… Dans le quartier . - se respecter et respecter les autres - respecter ses voisins et les saluer - ne pas injurier les gens - éviter la discrimination - respecter les règles du vivre ensemble"
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "DÉFINITIONS DES CONCEPTSLIES A LA RUE",
              "contenu": "Le chemin : c’est une voie plus large que le sentier. Le sentier : c’est un chemin étroit traversant les champs, les plantations, la brousse. La route : c’est un chemin praticable par les voitures en dehors des agglomérations. La rue : c’est une voie de circulation bordée de maisons dans une agglomération. La ruelle : c’est une petite rue étroite. L’autoroute : c’est une route à deux sens. Le boulevard : c’est une route très large parfois à deux sens traversant une ville. Le carrefour : c’est l’endroit où se croisent plusieurs routes. Le rond – point : c’est la place circulaire à laquelle aboutissent plusieurs routes. La chaussée : c’est la partie de la route où passent les automobiles. Le trottoir : c’est la partie de la route où passent les piétons. Le bas – côté : c’est une bande herbeuse ou piste caillouteuse le long de la route. Le passage piéton ou passage clouté : c’est la partie de la chaussée que les piétons peuvent traverser en toute sécurité."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Aimer et respecter son cadre de vie",
        "theme": "Connaissance de son cadre de vie : la rue",
        "titre": "Dangers potentiels de la rue",
        "seances": 2,
        "fiche": {
          "competence": "Aimer et respecter son cadre de vie",
          "theme": "Connaissance de son cadre de vie : la rue",
          ...
          "resumeStructure": [
            {
              "titre": "La rue",
              "contenu": "- permet le désenclavement des zones rurales ; - facilite la circulation des biens et des personnes ; - est un facteur important de développement des activités socio-économiques et culturelles ; - facilite les échanges commerciaux ; … 2-1- Définition des dangers potentiels de la rue. On appelle dangers potentiels de la rue, l’ensemble des accidents qui ont une relation avec la circulation routière. Exemple : la collision entre une voiture et une moto ou entre deux voitures ; le renversement d’une moto par un animal en divagation sur la route... 2-2- Les comportements dangereux dans la rue ou encore les causes des accidents de rue Ce sont. - jouer ou s’amuser dans la rue ; - La violation des feux tricolores ; - L’excès de vitesse ; - la méconnaissance du code de la route ; - La mauvaise traversée de la rue par les piétons ; - l’utilisation du téléphone portable, baladeurs et casques à la musique en circulation ; - Les troubles comportementaux (alcoolisme, somnolence, déficience visuelle et auditive) ; - La mauvaise occupation des trottoirs par les piétons et commerçants ; - marcher à sa droite ou sur la chaussée ;"
            },
            {
              "titre": "Autres dangers de la rue",
              "contenu": "- La divagation des animaux domestiques ; - La vétusté et le manque d’entretien de nombreux véhicules ; - Les phénomènes météorologiques (forte pluie, vents violents, tempêtes, etc.) ; - La traversée de la rue par les handicapés, les enfants et les personnes âgées ; - Le manque des feux et panneaux de signalisation à des endroits importants ;… Ce sont. - Les blessures; - La mort; - Le traumatisme crânien et corporel; - Les dégâts matériels; -Les dépenses ;… Les comportements civiques dans la rue."
            },
            {
              "titre": "Pour réduire les accidents de la rue, il faut",
              "contenu": "- éviter de jouer ou de s’amuser dans la rue ; - éviter de conduire en état d’ivresse (en étant saoulé) ; - respecter le code de la route ; - bien repérer les passages pour piétons ; -assister les handicapés, enfants et les personnes âgées lors de la traversée de la rue ; - être prudent et vigilant dans la rue ; - porter le casque et utiliser la ceinture de sécurité ; - s’arrêter avant de recevoir ou émettre un appel téléphonique ; …"
            }
          ],
      ...
      },
      {
        ...
        "competence": "Aimer et respecter son cadre de vie",
        "theme": "Connaissance de son cadre de vie : la rue",
        "titre": "Règles du code de la route",
        "seances": 3,
        "note": "Prévoir une sortie de classe pour expérimenter le code de la route.",
        "fiche": {
          "competence": "Aimer et respecter son cadre de vie",
          "theme": "Connaissance de son cadre de vie : la rue",
          "documentation": [
          ...
          "resumeStructure": [
            {
              "titre": "DÉFINITION",
              "contenu": "Le code de la route est l'ensemble des lois et réglements qui régissent la circulation routière."
            },
            {
              "titre": "LES CIBLES DU CODE DE LA ROUTE",
              "contenu": "Les cibles du code la route sont : piétons, cyclistes, motocyclistes, automobilistes"
            },
            {
              "titre": "NB: Les autres usagers de la route",
              "contenu": "- les usagers prioritaires ( ambulances/ véhicules militaires en mission); - Les handicapés; - les personnes âgées et les mineurs (enfants)… 3-1- Définition. Le piéton est un usager à pieds sur un trottoir ou une chaussée. Un usager qui pousse le vélo ou un handicapé à fauteuil roulant est aussi un piéton. 3-2- Quels sont les droits du piéton?. Ne pas cèder le passage à un piéton est une infraction. Pour cela si le feu piéton s'allume et que le piéton s'engage, il faut lui céder le passage. Au cas où il n'y a pas de feu tricolore, il faut ralentir ou s'arrêter quand un piéton s'engage."
            },
            {
              "titre": "Les devoirs du piéton sont les suivants",
              "contenu": "- emprunter les trottoirs à sa gauche ; - être vigilant en empruntant la chaussée au cas où il n'y a pas de trottoirs aménagés ; - utiliser les passages clouté/ piéton pour traverser la route ; - Vérifier à sa gauche et droite avant de traverser la route ; - éviter la manipulation du téléphone en pleine circulation ; - éviter l'ivresse en circulation ; - Traverser la route perpendiculairement et non diagonalement ; - marcher en fil et non en parallèle quand on est en groupe…"
            },
            {
              "titre": "En tant que cycliste on doit respecter les règles suivantes",
              "contenu": "- porter son casque de vélo ; - avoir un vélo bien équipé c'est-à-dire les freins, phare, avertisseur sonore, feux de position (avant et arrière), catadioptres ( avant et arrière) sont en bon état ; - rouler le plus à droite de la chaussée : - respecter la limite des vitesses ; - respecter les feux de signalisation aux intersections ; - ne pas rouler en sens interdit…"
            }
          ],
      ...
      },
      {
        ...
        "titre": "Utilité et organisation de l'école",
        "seances": 2,
        "fiche": {
          "competence": "Aimer et respecter son cadre de vie",
          "theme": "Connaissance de son cadre de vie : l'école",
          ...
          "resumeStructure": [
            {
              "titre": "1- Définition de l’école",
              "contenu": "L’école est un établissement dans lequel est donné un enseignement collectif (général ou spécialisé)."
            },
            {
              "titre": "L’école permet de",
              "contenu": "instruire : acquisition des connaissances, des aptitudes (lire, écrire, compter...) ; socialiser : faire des élèves des êtres capables de vivre en société ; qualifier : permettre à l’élève d’avoir des diplômes qui lui ouvrent le marché du travail."
            },
            {
              "titre": "ORGANISATION DU COLLÈGE",
              "contenu": "Le collège est un établissement d’enseignement secondaire du premier cycle. Au Togo, le collège d’enseignement général en abrégé CEG ou le 1er cycle du secondaire, est administré par une équipe de direction, un personnel administratif, un personnel d’appui, un personnel enseignant, des conseils et des structures d’appui. Le collège comporte quatre niveaux : la sixième, la cinquième, la quatrième et la troisième."
            },
            {
              "titre": "Le collège comporte deux cycles",
              "contenu": "Le cycle d’observation : la sixième et la cinquième. Le cycle d’orientation : la quatrième et la troisième. En troisième on passe l’examen du BEPC qui ouvre les portes du lycée ou le 2ème cycle du secondaire. Les matières obligatoires enseignées sont : le français, l’anglais ; l’histoire-géographie, l’ECM, la SVT, les mathématiques et la PCT. Les matières facultatives enseignées : l’EPS, le dessin, la musique, l’enseignement ménager, l’arabe, l’EWE, le Kabyè… Extrait de l’arrêté N° 062/MEPSTA/CAB/SG, redéfinissant les règles d'organisation et de fonctionnement des collèges d'enseignement général publics. - etc."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "FONCTIONNEMENT D’UN COLLÈGE",
              "contenu": "Le collège est une institution publique de formation générale qui accueille les élèves titulaires du CEPD."
            },
            {
              "titre": "Personnel administratif",
              "contenu": "Le Directeur : il est le chef de l’établissement qu’il représente devant l’autorité, il est le garant de la bonne marche de l’établissement. Le Directeur-adjoint : remplace le Directeur en cas d’absence ou d’empêchement. Il est le directeur des études. Le Surveillant Général : il assure l’encadrement des élèves pour une bonne discipline au sein de l’établissement. Le ou les secrétaire(s) : il s’occupe de la saisie des devoirs, des documents scolaires, de l’accueil des visiteurs. L’Econome : il se charge de la perception des frais de scolarité, de l’achat du matériel. Le bibliothécaire : il est chargé de la tenue et de la gestion des documents scolaires. L’Infirmier : il accueille dans son infirmerie les élèves malades et leur donne les premiers soins."
            },
            {
              "titre": "Personnel enseignant",
              "contenu": "Il est composé de tous les enseignants de l’établissement chargés de l’enseignement. N.B : Chaque classe dispose d’un professeur titulaire qui joue le rôle de tuteur de sa classe. 1.3- Comité d’élèves. Il représente les élèves de l’établissement et aide l’administration. N.B : Le comité de chaque classe apporte son aide au professeur titulaire de la classe."
            },
            {
              "titre": "VIE DANS UN COLLÈGE",
              "contenu": "La vie dans un collège est régie par le règlement intérieur. Le règlement intérieur étant la loi fondamentale de l’établissement, il anime la vie au collège. 2-1- Rythme journalier. Le collège fonctionne durant 5 jours dans la semaine, du lundi au vendredi. Les cours se déroulent tous les jours, de 7H00 à 12H00 le matin et l’après-midi de 15H00 à 17H 00. N.B : Aucune sortie de l’établissement pendant les heures de classe n'est autorisée, sauf pour motif valable et sur demande écrite et signée des parents qui doivent venir eux- mêmes (ou la personne nommément désignée) chercher l'enfant dans la classe. 2-2- Activités para et périscolaires. Ce sont des activités qui sont organisées pour permettre à chaque apprenant d’exercer ses dons personnels et manifester ses goûts et opinions. 2-2-1- Activités périscolaires . Ce sont des activités qui se déroulent « autour du collège ». Exemples : théâtre, musique, danse, chorale, sport, le jardin scolaire, … 2-2-2- Activités parascolaires . Ce sont des activités qui se déroulent « à côté du collège » et dont parallèles à l’école. Mais elles peuvent être aussi pratiquées au sein de l’école. Exemples : la coopérative scolaire, les troupes théâtrales, les équipes sportives, la chorale, les excursions"
            },
            {
              "titre": "RÉSOLUTIONS POUR ÊTRE UN BON COLLÉGIEN",
              "contenu": "Un bon collégien doit-être : ponctuel, assidu et fournir toujours un travail exemplaire. Aussi, doit-il promouvoir le respect de la discipline et de la propreté et la culture du vivre ensemble."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "TYPES DE SUBDIVISIONS AU TOGO",
              "contenu": "Les types de subdivisions au Togo sont : les circonscriptions administratives (structures déconcentrées) et les collectivités territoriales (structures décentralisées)."
            },
            {
              "titre": "CIRCONSCRIPTIONS ADMINISTRATIVES",
              "contenu": "Les circonscriptions administratives du Togo sont : la région, la préfecture, le canton, le village et le quartier. 2-1- La région. La région est une personne de droit public dotée d’une autonomie financière composée de plusieurs préfectures. Elle est dirigée par un gouverneur nommé par le Président de la République. Le Togo compte 6 régions administratives (District Autonome du Grand Lomé, Maritime, Plateaux, Centrale, Kara et Savanes) 2-2- La préfecture. La préfecture est une circonscription administrative composée de plusieurs cantons ou communes dirigée par un préfet nommé par le Président de la République. Le Togo compte 39 préfectures. 2-3- Le canton. Le canton est une circonscription administrative composée de plusieurs villages ou quartiers dirigée par un chef canton nommé par Décret présidentiel. Le Togo compte 387 cantons. 2-4- Le village. Le village est une circonscription administrative rurale dirigée par un chef du village nommé. 2-5- Le quartier. Le quartier est une circonscription administrative urbaine dirigée par un chef du quartier nommé."
            },
            {
              "titre": "COLLECTIVITÉS TERRITORIALES",
              "contenu": "Le territoire national est divisé en deux collectivités territoriales dotées de la personnalité morale et de l’autonomie financière. Ces collectivités territoriales sont : la commune et la région. 3-1- La commune. La commune est une collectivité territoriale composée de plusieurs cantons. Elle est dirigée par un élu local appelé maire pour un mandat de 6 ans. Le Togo compte 117 communes. 3-2- La région. La région est une personne de droit public dotée d’une autonomie financière et composée de plusieurs préfectures. Elle est dirigée par un gouverneur nommé par le Président de la République. Le Togo compte 6 régions administratives (District Autonome du Grand Lomé, Maritime, Plateaux, Centrale, Kara et Savanes). NB : La région est à la fois une circonscription administrative (car le gouverneur est nommé) et une collectivité territoriale (car dirigée par un président du conseil régional élu)."
            },
            {
              "titre": "CAS PARTICULIER DU DISTRICT AUTONOME DU GRAND LOMÉ (DAGL)",
              "contenu": "Le District Autonome du Grand Lomé (DAGL) est une entité territoriale particulière. Il est régi par des règles de la décentralisation et de la déconcentration. Il regroupe un ensemble de communes et de préfectures. Il est composé de moitié de conseillers municipaux désignés par les communes et de moitié de personnalités nommées par le Président de la République. Il regroupe les préfectures d’AGOE-NYIVE et du GOLFE et des communes des deux préfectures. Il est administré par un conseil du district composé de 53 membres : le gouverneur (nommé) ; de 26 élus locaux dont deux par commune et de 26 personnalités (nommées). Son bureau exécutif se compose du gouverneur, de trois vices gouverneurs (nommés parmi les conseillers municipaux) et d’un secrétaire et d’un adjoint au secrétaire (nommés par le gouverneur parmi les conseillers)."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1- Définition du canton",
              "contenu": "Le canton est une unité territoriale regroupant plusieurs villages ou quartiers. Au Togo, on compte 387 cantons. Mon école se trouve dans le canton de….. 1-2- Organisation administrative du canton. A la tête du canton se trouve le chef canton. Il est aidé dans ses tâches par les notables. Ils aident le chef canton dans la prise de décisions lors des conseils."
            },
            {
              "titre": "Le canton a pour attributions ou fonctions de",
              "contenu": "- garder les us et coutumes du milieu ; -régler les problèmes fonciers (problèmes de terre) -régler les problèmes de sorcellerie ; -gérer les problèmes quotidiens de cohabitation. RÔLE DES CANTONS DANS LA DÉCENTRALISATION AU TOGO."
            },
            {
              "titre": "Dans la décentralisation au Togo, les cantons ont pour rôle de",
              "contenu": "- relayer l'administration publique sur place ; - promouvoir le développement local ; - promouvoir le vivre ensemble ; -appuyer les CCD (Comité Cantonal de Développement), CVD (Comité Villageois de Développement) et CDQ (Comité de Développement du Quartier)…"
            }
          ],
      ...
      },
      {
        ...
        "titre": "Symboles du Togo (armoiries, hymne national, devise, drapeau)",
        "seances": 4,
        "note": "Faire acquérir aux apprenants l'hymne national et la marche républicaine.",
        "fiche": {
          "competence": "Respecter l'État, ses institutions et ses organes décentralisés",
          "theme": "Symboles, principes et valeurs du Togo",
          "documentation": [
          ...
          "resumeStructure": [
            {
              "titre": "Les symboles de l'État togolais",
              "contenu": "Un symbole est une représentation figurée, imagée et concrète d'un État. Les principaux symboles de l'État togolais sont les armoiries, l'hymne national, la devise et le drapeau."
            },
            {
              "titre": "Les armoiries",
              "contenu": "Les armoiries sont l'emblème officiel de l'État togolais, composées d'un écu central encadré par deux lions, surmonté de la devise nationale."
            },
            {
              "titre": "L'hymne national",
              "contenu": "L'hymne national du Togo, intitulé « Terre de nos aïeux », a été adopté à l'indépendance en 1960. Il glorifie la patrie togolaise et l'unité de son peuple, et se chante lors des cérémonies officielles. Ses paroles complètes doivent être apprises et chantées en classe plutôt que recopiées."
            },
            {
              "titre": "La devise",
              "contenu": "La devise du Togo est « Travail - Liberté - Patrie », exprimant les valeurs fondamentales de la nation togolaise."
            },
            {
              "titre": "Le drapeau et son symbolisme",
              "contenu": "Le drapeau togolais comporte cinq bandes horizontales alternées de vert et de jaune, avec un canton rouge portant une étoile blanche à cinq branches. Le vert symbolise l'espoir, le jaune les richesses du pays, le rouge la fidélité, et l'étoile blanche la pureté et l'unité nationale. L'élève doit connaître et respecter ces symboles nationaux."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Respecter l'État, ses institutions et ses organes décentralisés",
        "theme": "Symboles, principes et valeurs du Togo",
        "titre": "Principes et valeurs du Togo",
        "seances": 2,
        "fiche": {
          "competence": "Respecter l'État, ses institutions et ses organes décentralisés",
          "theme": "Symboles, principes et valeurs du Togo",
          ...
          "resumeStructure": [
            {
              "titre": "1- Définition",
              "contenu": "Les principes républicains sont un ensemble de règles de conduite définissant la manière d’agir au sein d’une société. 1-2- Les principes de la République togolaise. Ce sont : Etat de droit, la laïcité, la démocratie, Etat social, l’unicité, l’égalité, l’indivisibilité, le respect mutuel, la protection des droits de l’homme, … 2-1- Définition. Les valeurs républicaines sont des normes qui servent de référence à la vie sociale. 2-2- Les valeurs de l’Etat togolais. Ce sont : le travail, la liberté, l’unité, la dignité, la patrie, la solidarité, le partage, la paix, la coopération, la justice, le progrès, l’harmonie sociale, l’équité, le respect des valeurs traditionnelles et spécifiques culturelles…"
            }
          ],
      ...
      },
      {
        ...
        "titre": "Violence et extrémisme violent",
        "seances": 2,
        "fiche": {
          "competence": "Régler les conflits de façon pacifique",
          "theme": "Notion de violence",
          ...
          "resumeStructure": [
            {
              "titre": "1- Définition de la violence",
              "contenu": "La violence est l’utilisation de la force physique ou mentale pour dominer, contraindre ou faire du mal à autrui. 1-2- Différentes formes de violence. - La violence psychologique ou morale : critiquer constamment quelqu’un, manipuler les émotions de quelqu’un, menaces, chantages… - La violence verbale : injures, insultes, brimades, harcèlement, hurlements, humiliations, intimidations, - La violence physique : coups, châtiments, gifles, fessés - La violence sexuelle : attouchements sexuels, viol - La violence économique : contrôle financier imposé, dépendance financière forcée, surveillance accrue du budget ; - Les cybers violences : les sextapes, l’usurpation d’identité, la publication de fausses informations sur une personne... 1-3- Rapport entre violence et extrémisme violent. L’extrémisme violent est une forme de violence caractérisée par une volonté de détruire et de mettre fin à des systèmes politiques, religieux ou sociaux existants alors que la violence est motivée par des problèmes individuels ou sociaux spécifiques. Ce sont . - l’intolérance - l’ethnocentrisme - la discrimination - l’injustice - l’absence de liberté - les échecs scolaires - Les films de violence ; - La consommation des stupéfiants (drogues) ; - Le chômage ; - La pauvreté ; - L’ignorance des textes en vigueur ; - Le poids de la tradition ; - L’absence d’un État de droit ; - Le racisme ; - Les problèmes de l’éducation ; - Les problèmes familiaux ; - Les problèmes fonciers ; - L’héritage... 3-1- Manifestations des violences. - la violence active: le châtiment corporel, les coups ; les a bus sexuels ; le harcèlement sexuel, viols ; les blessure… - la violence passive: Le refus de saluer ou de pardonner ; l’indifférence ; le mépris, les injures, les insultes, l’humiliation, les intimidations, le harcèlement, la ridiculisation, détruire les biens d’autrui, gaspiller de la nourriture, les mimiques,… 3-2- Manifestation de l’extrémisme violent. Chez l’individu, l’extrémisme violent se manifeste par la radicalisation et la marginalisation sociale Dans la communauté, il se manifeste sous forme d’isolation (se sentir discriminé ; ce qui pousse l’individu à rejoindre des groupes extrémistes et à commettre des actes de violence et de vandalisme) ; la polarisation sociale (tensions intercommunautaires, augmentation des discours de haine, méfiance généralisée envers certaines communautés ; ce qui crée des divisions et des conflits et pousse l’individu à commettre les émeutes, les affrontements violents) ; la formation des groupes extrémistes."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Régler les conflits de façon pacifique",
        "theme": "Notion de violence",
        "titre": "Conséquences de la violence et de l'extrémisme violent",
        "seances": 2,
        "fiche": {
          "competence": "Régler les conflits de façon pacifique",
          "theme": "Notion de violence",
          ...
          "resumeStructure": [
            {
              "titre": "Il s’agit de",
              "contenu": "Les problèmes de santé : les blessures, les IST, les fractures, la perte d’appétit ... Les troubles psychologies : les victimes peuvent avoir la folie, le manque de confiance en soi ; la dépression, les tentatives de suicide, le désespoir, le refuge dans la drogue et l’alcool.... Troubles comportementaux : vol, viol, la délinquance, les difficultés scolaires, les comportements violents..."
            },
            {
              "titre": "Problèmes psychologiques : agressifs, idées suicidaires",
              "contenu": "Sanctions pénales : ces auteurs sont punis selon la loi en vigueur (paiement des dommages et intérêt, emprisonnement…)"
            },
            {
              "titre": "La criminalisation",
              "contenu": "La perturbation des relations familiales (le rejet de la famille, la perte d’une confiance mutuelle…) 4- CONSEQUENCES SUR LA COMMUNAUTE OU LA SOCIETE DE L’EXTREMISME VIOLENT Ce sont. La détérioration de l’image de la communauté (la psychose, la division, la méfiance au sein de la communauté…). Les dégradations économiques (la destruction des infrastructures, des biens, la baisse du tourisme et des investissements) La peur. Les dégradations matérielles (destruction des routes, des ponts, des habitations…) Les pertes de vies humaines (les déplacements forcés de la population, les pertes massives et cruelles de vies humaines, les génocides…)"
            }
          ],
      ...
      },
      {
        ...
        "titre": "Pollution de l'environnement",
        "seances": 2,
        "fiche": {
          "competence": "Promouvoir le développement durable",
          "theme": "Santé, environnement et développement",
          ...
          "resumeStructure": [
            {
              "titre": "LES ACTIVITES HUMAINES QUI POLLUENT NOTRE ENVIRONNEMENT IMMEDIAT",
              "contenu": "Les activités humaines qui polluent environnement : les activités agricoles (avec utilisation des engrais chimiques et des pesticides) ; les activités industrielles (avec de produits toxiques et dégagement de gaz polluants et déversement d’eaux contaminées) ; les transports (avec déversement de vidanges, dégagement de gaz polluants et production de bruits sonores) ; les activités commerciales et domestiques (avec déversement d’eaux usées et production de déchets solides)."
            },
            {
              "titre": "LES EFFETS DES ACTIVITES HUMAINES SUR L’ENVIRONNEMENT",
              "contenu": "Les effets des activités humaines sur l’environnement sont : le réchauffement climatique, pollution de l’air, la pollution de l’eau, la pollution ou dégradation du sol, la déforestation, l'épuisement des ressources, …"
            },
            {
              "titre": "EFFETS DE LA DEGRADATION DE L’ENVIRONNEMENT SUR LA SANTE",
              "contenu": "Les effets de la pollution de l’environnement sur notre santé sont multiples. On peut noter : La baisse de la qualité de la vie : nuisances sonores, prolifération de moustiques et de rongeurs, conflits entre voisins, blocage des voies par des tas d’immondices et accidents, dégagement d’odeurs nauséabondes, perte de l’audition, trouble de sommeil, infertilité, stress… Les maladies comme : les maladies respiratoires, cardio-vasculaires, articulaires et cancéreuses, allergies, pandémies, contaminations, intoxications, épidémies, crises d'asthme,…"
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "DEFINITION DE LANOTION DE DEVELOPPEMENT DURABLE",
              "contenu": "Le développement durable est un développement qui répond aux besoins du présent sans compromettre la capacité des générations futures à répondre aux leurs"
            },
            {
              "titre": "PROMOTION DU DÉVELOPPEMENT DURABLE",
              "contenu": "Comme solutions à la dégradation de l’environnement, nous devons mener des actions suivantes en faveur du développement durable : - pratiquer l’agriculture bio, - utiliser les moteurs non-polluants, - promouvoir le reboisement, - Diminuer la consommation d’énergie - Utiliser le numérique à bon escient - Trier les déchets -Privilégier le matériel éco-conçu et les fournitures écologiques -Penser au cycle de vie des objets…"
            }
          ],
    ...
    "lecons": [
      {
        ...
        "theme": "Citoyenneté",
        "titre": "Notion de citoyen et de citoyenneté",
        "seances": 2,
        "fiche": {
          "competence": "Adopter des comportements responsables",
          "theme": "Citoyenneté",
          ...
          "resumeStructure": [
            {
              "titre": "DEFINITION DES CONCEPTS RELATIFS A LA CITOYENNETE",
              "contenu": "Citoyen : est une personne appartenant à un Etat jouissant de ses droits civiques et politiques. Le citoyen est une personne qui jouit des mêmes droits et obéit aux mêmes lois que les autres dans un pays. NB : Au Togo, on devient citoyen si on a la nationalité. Citoyenneté : est la qualité d’un citoyen participant à la gestion des affaires de son pays et jouissant de ses droits et libertés. Adopter un comportement citoyen : c’est être responsable et autonome individuellement et collectivement. EXEMPLES : respecter les couleurs nationales ; protéger les biens publics ; payer ses impôts, taxes et factures diverses…"
            },
            {
              "titre": "a) Définition",
              "contenu": "La nationalité : c’est le lien d’appartenance juridique d’une personne à une nation. La majorité : est le statut juridique que la loi attache à la personne qui a atteint l’âge de 18 ans. Au Togo, l’âge de la majorité est fixé à 21 ans."
            },
            {
              "titre": "b) Conditions d’acquisition de la nationalité au Togo",
              "contenu": "La qualité d’un bon citoyen est liée à l’obtention de la nationalité. En effet, au Togo, la nationalité s’acquiert dans les conditions suivantes :"
            },
            {
              "titre": "Par filiation (droit de sang)",
              "contenu": "-Etre né (e) d’un père togolais et d’une mère togolaise -Etre né (e) d’un père togolais et d’une mère étrangère -Etre né (e) d’un père étranger ou de nationalité inconnue et d’une mère togolaise"
            },
            {
              "titre": "Par naissance sur le territoire togolais (droit de sol)",
              "contenu": "-Etre né (e) sur le sol togolais"
            },
            {
              "titre": "Par naturalisation (droit de mariage)",
              "contenu": "-la femme étrangère qui épouse un togolais acquiert la nationalité togolaise -sur demande d’un étranger résidant au Togo"
            }
          ],
      ...
      },
      {
        ...
        "competence": "Adopter des comportements responsables",
        "theme": "Citoyenneté",
        "titre": "Droits et devoirs du citoyen togolais",
        "seances": 2,
        "fiche": {
          "competence": "Adopter des comportements responsables",
          "theme": "Citoyenneté",
          ...
          "resumeStructure": [
            {
              ...
              "contenu": "Les droits sont des prérogatives permises à chaque individu. Les droits du citoyen togolais sont contenus dans la constitution togolaise du 14 octobre 1992 à son titre 2 ; au sous-titre 1. Ces droits sont :"
            },
            {
              "titre": "DEVOIRS DU CITOYEN",
              "contenu": "Les devoirs sont des obligations morales du citoyen envers son État. Les devoirs du citoyen togolais sont contenus dans la constitution togolaise du 14 octobre 1992 à son titre 2 ; sous-titre 2. Ces devoirs sont :"
            },
            {
              "titre": "Devoir d’éviter de troubler l’ordre public,",
              "contenu": "Devoir de respecter l’Etat, ses institutions publiques et politiques, ses lois"
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définition de la commune",
              "contenu": "La loi n° 2019-006 du 26 juin 2019 sur la Décentralisation et libertés locales au Togo (article 56) définit la commune comme une collectivité territoriale de base, dotée de la personnalité morale et de l'autonomie financière, regroupant plusieurs cantons et dirigée par un maire. Le Togo compte aujourd'hui 117 communes."
            },
            {
              "titre": "2. Organisation administrative de la commune",
              "contenu": "Selon l'article 58 de cette même loi, la commune fonctionne grâce au Conseil municipal (assemblée des conseillers élus chargée de gérer les affaires communales), au Bureau exécutif (le maire et ses adjoints, élus par les conseillers pour un mandat de 6 ans renouvelable une fois), ainsi qu'à des services techniques (état civil, voirie, comptabilité) et des commissions (économique, domaniale, action sociale)."
            },
            {
              "titre": "3. Les attributions de la commune",
              "contenu": "Selon l'article 82, la commune est notamment chargée de : délivrer et légaliser les actes d'état civil (naissance, mariage, décès), coordonner la police municipale, entretenir les voies communales, gérer l'urbanisme, créer et gérer les gares routières et marchés, construire les écoles primaires et dispensaires, voter le budget communal et collecter les taxes locales."
            },
            {
              "titre": "4. Les stratégies de développement de la commune",
              "contenu": "Plusieurs stratégies favorisent le développement des communes togolaises : l'élaboration d'un Plan de Développement Communal (PDC), l'inventaire des ressources locales (fiscales, dotations de l'État, emprunts), la participation de la population locale à la gestion communale, et le développement de partenariats avec des ONG et d'autres communes."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "La préfecture est une collectivité territoriale intermédiaire entre la commune et la région.",
              "contenu": "C’est aussi une collectivité territoriale dotée de la personnalité morale et de l’autonomie financière. Elle est un ensemble formé de plusieurs cantons ou communes. Le Togo compte 39 préfectures. La préfecture a une organisation tripartite : le Préfet, le Cabinet du Préfet et le Secrétariat général 2-1- le préfet. Il est le dépositaire de l’autorité de l’Etat dans la préfecture."
            },
            {
              "titre": "Le préfet a plusieurs attributions",
              "contenu": "il est une autorité politique, un haut fonctionnaire qui représente le pouvoir central dans sa préfecture ; il a la charge de l’ordre public, de la sécurité et de la protection de la population, il a le pouvoir de gérer les conflits entre les communes de sa préfecture (après avis des services techniques déconcentrés des ministères concernés),"
            },
            {
              "titre": "il coordonne la politique nationale dans sa préfecture,",
              "contenu": "il est chargé de l’exécution des lois et règlements venant du pouvoir central dans sa préfecture,… 2-2- le cabinet du préfet. Il est dirigé par un directeur de cabinet qui tient à jour les courriels, les rapports de missions et déplacements officiels du préfet. Il est le collaborateur direct du Préfet. 2-3- le secrétariat général. Il est dirigé par un secrétaire général placé sous l’autorité du Préfet. Il assure l’intérim du préfet en cas d’absence ou de vacance. Il gère le budget et le patrimoine de la préfecture. Il est chargé d’assurer le suivi des projets du gouvernement dans la préfecture, tient à jour tous les rapports de missions et d’activités dans la préfecture ; gère aussi, les courriels venant du gouvernement dans la préfecture …"
            },
            {
              "titre": "La préfecture",
              "contenu": "- traite les affaires liées à la délivrance des pièces d’identité (nationalité),"
            }
          ],
      ...
      },
      {
        ...
        "titre": "Rôles du parti politique et de la société civile",
        "seances": 2,
        "ecartGuide": true,
        "fiche": {
          "competence": "Adopter des comportements responsables",
          ...
          "resumeStructure": [
            {
              "titre": "Le parti politique et la société civile",
              "contenu": "- Un parti politique est un regroupement de personnes ayant une même idéologie et dont l’objectif est la conquête et l’exercice du pouvoir. Exemples : Au Togo, nous avons : UNIR, NET, ANC, UFC, CDPA La majorité ou parti majoritaire : est un parti ou une coalition de partis détenant le plus grand nombre de siège dans une assemblée Exemple : UNIR (Togo) La minorité ou le parti minoritaire est un parti ou une coalition de partis ayant obtenu moins de la moitié des sièges dans une assemblée Exemple : NET, CAR, UFC (Togo) Le parti au pouvoir est un parti ou une coalition de partis qui soutiennent le gouvernement Exemple : UNIR (Togo) NB : Le parti majoritaire peut devenir un parti d’opposition s’il perd les élections Le parti d’opposition est un parti ou groupe de partis qui s’oppose au parti au pouvoir"
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "DEFINITION",
              "contenu": "Le règlement intérieur de l’établissement est un document qui définit les droits et devoirs de chacun des membres de la communauté scolaire. C’est également la loi fondamentale de l’école."
            }
          ],
      ...
      },
      {
        ...
        "titre": "Droits humains et dignité humaine",
        "seances": 2,
        "fiche": {
          "competence": "Respecter les droits et libertés des autres",
          "theme": "Droits humains",
          ...
          "resumeStructure": [
            {
              "titre": "Définition des droits humains",
              "contenu": "Les droits humains sont l’ensemble des droits, libertés et prérogatives reconnus aux Hommes en leur seule qualité d’êtres humains. Ce sont, aussi, des garanties juridiques universelles qui protègent les individus contre les violations des libertés fondamentales. On peut également définir les droits humains comme des droits moraux inaliénables et inhérents à chaque être humain du seul fait qu’il est un être humain."
            },
            {
              "titre": "Principes des droits humains",
              "contenu": "Les droits humains sont basés sur des principes qui doivent être respectés. Ces principes sont :"
            },
            {
              "titre": "L’universalité (aucun individu ne doit être exclu des droits humains)",
              "contenu": "L’indivisibilité (les droits humains doivent être reconnus et protégés sans exception et sans établir un ordre de préférence)"
            },
            {
              "titre": "L’inaliénabilité (les droits humains ne peuvent être abrogés)",
              "contenu": "L’imprescriptibilité (les droits humains ne sont pas susceptibles de disparaitre dans le temps)"
            },
            {
              "titre": "définition de la dignité humaine",
              "contenu": "La dignité humaine est le respect que mérite une personne."
            },
            {
              "titre": "les actes et comportements qui portent atteinte à la dignité humaine",
              "contenu": "Les atteintes à la dignité humaine désignent toutes les formes d’infractions qui ont pour motivation ou effet de porter atteinte à l’intégrité physique ou psychologique d’autrui. Ces actes et comportements sont : la discrimination ; la diffamation ; le harcèlement ; le proxénétisme ; les violences"
            }
          ],
      ...
      },
      {
        ...
        "competence": "Respecter les droits et libertés des autres",
        "theme": "Droits humains",
        "titre": "Droits et libertés fondamentaux de l'homme",
        "seances": 2,
        "fiche": {
          "competence": "Respecter les droits et libertés des autres",
          "theme": "Droits humains",
          ...
          "resumeStructure": [
            {
              "titre": "LES DIFFERENTES CATEGORIES DES DROITS HUMAINS",
              "contenu": "Les droits humains sont des garanties juridiques universelles qui protègent les individus contre les violations des libertés fondamentales. Ces droits sont contenus dans la Déclaration Universelle de Droit de L’homme (DUDH), adoptée le 10 Décembre 1948 à Paris par l’Assemblée Générale des Nations Unies. Ainsi, distingue-t-on : Les droits civils et politiques (Libertés et droits fondamentaux de l’Homme) Ce sont des droits reconnus à tous les êtres humains. Ils visent à assurer la liberté de l’individu contre l’État limitant le pouvoir des gouvernements."
            },
            {
              "titre": "Les droits socio-économiques et culturels (droits sociaux)",
              "contenu": "Ce sont des droits de prestations. Ces droits visent à garantir le bien-être social, économique et culturel de l’être humain et assurer l’égalité entre les hommes."
            },
            {
              "titre": "les droits collectifs (novateurs ou de solidarité)",
              "contenu": "Ils sont dits les droits de la 3è génération et sont contenus dans la Charte de Banjul."
            },
            {
              "titre": "LES DROITS ET LIBERTES FONDAMENTAUX DE L’HOMME",
              "contenu": "les droits fondamentaux de l’homme (droits subjectifs primordiaux de l’individu)"
            }
          ],
      ...
      },
      {
        ...
        "competence": "Respecter les droits et libertés des autres",
        "theme": "Droits humains",
        "titre": "Droits spécifiques ou catégoriels",
        "seances": 2,
        "fiche": {
          "competence": "Respecter les droits et libertés des autres",
          "theme": "Droits humains",
          ...
          "resumeStructure": [
            {
              "titre": "DEFINITION DE DROIT SPECIFIQUE",
              "contenu": "Les droits spécifiques sont des droits accordés à certaines catégories de personnes à cause de leur vulnérabilité. Ils sont encore appelés des droits catégoriels."
            },
            {
              "titre": "Les différentes catégories de droits spécifiques sont",
              "contenu": "- Doits des enfants"
            }
          ],
      ...
      },
      {
        ...
        "titre": "Santé sexuelle de l'adolescent",
        "seances": 2,
        "fiche": {
          "competence": "Prendre soin de sa santé et entretenir son milieu de vie",
          "theme": "Santé et environnement",
          ...
          "resumeStructure": [
            {
              "titre": "LES TRANSFORMATIONS PHYSIQUES AU COURS DE L 'ADOLESCENCE",
              "contenu": "L’adolescence est une période de la vie d'un individu, correspondant à la phase de maturation qui fera passer cet individu de l'état d'enfant à celui d'adulte. C’est aussi le passage de l’état d’enfant à celui d’adulte. La puberté est la période de maturation biologique d'un individu, à l'issue de laquelle il deviendra apte à la procréation. C'est donc un concept purement biologique."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "Notion de parenté précoce et de parenté responsable",
              "contenu": "La parenté précoce est le fait, pour un adolescent, d'être parent ou géniteur avant l'âge adulte. C'est aussi la qualité de quelqu'un qui est parent avant l'âge de la maturité (18 ans). La parenté responsable est la capacité pour un parent d'assumer ses responsabilités de père ou de mère."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Prendre soin de sa santé et entretenir son milieu de vie",
        "theme": "Santé et environnement",
        "titre": "Tabagisme et toxicomanie",
        "seances": 4,
        "fiche": {
          "competence": "Prendre soin de sa santé et entretenir son milieu de vie",
          "theme": "Santé et environnement",
          ...
          "resumeStructure": [
            {
              "titre": "LES DIFFERENTS TYPES DE DROGUES",
              "contenu": "La drogue, étant une substance chimique ou un comprimé biochimique, est classée en quatre (4) catégories : Les sédatifs ou dépresseurs : ce sont des drogues qui calment l’anxiété ou la tension nerveuse et favorisent l’endormissement. (Exemples : l’alcool, la morphine, l’héroïne, l’opium, le diazépam, la valériane, la mélatonine) Les stimulants ou excitants : ce sont des drogues qui accélèrent l’activité du système nerveux central et qui causent l’excitation et de l’agitation. (Exemples : la cocaïne, le café, le tabac, le crack, les amphétamines, la noix de cola)"
            }
          ],
      ...
      },
      {
        ...
        "competence": "Prendre soin de sa santé et entretenir son milieu de vie",
        "theme": "Santé et environnement",
        "titre": "Protection de l'environnement au Togo",
        "seances": 2,
        "fiche": {
          "competence": "Prendre soin de sa santé et entretenir son milieu de vie",
          "theme": "Santé et environnement",
          ...
          "resumeStructure": [
            {
              "titre": "Définition",
              "contenu": "L’environnement est l’ensemble de tout ce qui nous entoure. C’est aussi l’ensemble des éléments biotiques et abiotiques qui entourent un individu ou une espèce. Le cadre juridique est l’ensemble des lois relatives à la protection de l’environnement. 1-2- Le cadre juridique de la protection de l’environnement La constitution de la IVème République togolaise constitue le fondement juridique de l’action environnementale au Togo. L’article 41 de la constitution réaffirme le droit de tout citoyen à l’environnement sain. Un environnement sain est un environnement favorable à la santé et au bien-être de l’homme. Le cadre juridique est constitué de 03 principales lois. Il s’agit de : La loi n°2008-005 du 30 mai 2008 portant la loi-cadre sur l’environnement"
            },
            {
              "titre": "La loi n°2008-009 du 19 juin 2008 portant code forestier",
              "contenu": "La loi n°2009-001 du 6 janvier portant prévention des risques biotechnologiques."
            },
            {
              "titre": "le code foncier et domanial",
              "contenu": "et plusieurs textes relatifs à la gestion de l’environnement tel que :"
            },
            {
              "titre": "le plan national d’actions pour l’environnement,",
              "contenu": "le plan national de lutte contre la désertification et la dégradation des terres, le programme national de gestion de l’environnement."
            }
          ],
      ...
      },
      {
        ...
        "theme": "Non-violence",
        "titre": "Non-violence et lutte contre l'extrémisme violent",
        "seances": 2,
        "fiche": {
          "competence": "Adopter des comportements faisant montre de valeurs de paix et de non-violence",
          "theme": "Non-violence",
          ...
          "resumeStructure": [
            {
              "titre": "Notion de non-violence",
              "contenu": "La non-violence est un ensemble de comportements qui rejettent la violence sous toutes ses formes. Elle est, aussi, un mode de relation qui favorise le dialogue et la médiation dans une approche constructive des conflits et qui peut se traduire par des actions collectives. C’est l’opposition à la violence sans nuire ou causer du tort à autrui."
            },
            {
              "titre": "Les valeurs portées par la non-violence",
              "contenu": "La non-violence vise à restaurer la dignité et la valeur absolue des êtres humains. Aussi, la non-violence est un projet ; celui de construire une culture de paix, une société démocratique basée sur certaines valeurs. Ces valeurs sont :"
            }
          ],
      ...
      },
      {
        ...
        "competence": "Adopter des comportements faisant montre de valeurs de paix et de non-violence",
        "theme": "Non-violence",
        "titre": "Martin Luther King et la lutte pour les droits civiques des Noirs",
        "seances": 2,
        "fiche": {
          "competence": "Adopter des comportements faisant montre de valeurs de paix et de non-violence",
          "theme": "Non-violence",
          ...
          "resumeStructure": [
            {
              "titre": "BIOGRAPHIE DE MARTIN LUTHER KING",
              "contenu": "Martin Luther King de son vrai nom Michael King Junior est né à Atlanta, en Géorgie, le 15 janvier 1929, et mort assassiné le 4 avril 1968 à Memphis, dans le Tennessee (USA). Cet afro-américain militant non-violent pour le mouvement des droits civiques, fervent militant pour la paix et contre la pauvreté a prononcé un célèbre discours I have a dreams (« j’ai fait un rêve ») le 28 août 1963, durant la marche pour l'emploi et la liberté en faveur d’un pays où règneraient justice et paix pour tous les êtres humains quelle que soit leur couleur de peau, qui a traversé le temps et continue d’inspirer au-delà des frontières étasuniennes. 2- LUTTE NON VIOLENTE DE MARTIN LUTHER KING POUR LA DEFENSE DES DROITS CIVIQUES DES NOIRS A l’époque de Martin Luther King, les Noirs n’ont pas partout les mêmes droits que les Blancs. Ils sont victimes de ségrégation raciale. MLK va organiser des marches et diriger des actions telles que le boycott des bus de Montgomery pour défendre le droit de vote, la déségrégation et l'emploi des minorités ethniques. Sa lutte débouchera avec le soutien du président Johnson sur le vote de différentes lois fédérales comme le Civil Rights Act de 1964, le Voting Rights Act de 1965 et le Civil Rights Act de 1968, qui mettent juridiquement fin à toutes les formes de ségrégation raciale sur l'ensemble des États-Unis. Martin Luther King devient le plus jeune lauréat du prix Nobel de la paix en 1964 pour sa lutte non- violente contre la ségrégation raciale et pour la paix. Il se voit décerner à titre posthume la médaille présidentielle de la Liberté par Jimmy Carter en 1977, le"
            }
          ],
    ...
    "lecons": [
      {
        ...
        "titre": "Pratiques démocratiques à l'école",
        "seances": 4,
        "fiche": {
          "competence": "Adopter des comportements responsables",
          "theme": "Démocratie à l'école",
          ...
          "resumeStructure": [
            {
              "titre": "1. L’exercice de la démocratie à l’école",
              "contenu": "Définition des concepts - La démocratie : est un régime politique dans lequel le pouvoir appartient au peuple. - L’école : est un établissement dans lequel se donne un enseignement collectif (général ou spécialisé). - La démocratie à l’école est l’application des règles démocratiques à l’école ou en milieu scolaire. Comment s’exerce la démocratie à l’école ? Plusieurs comportements et pratiques permettent de voir qu’il y a la démocratie à l’école. Dans l’exercice de cette démocratie, on retrouve : - le respect des textes qui gouvernent le collège (précis de législation, règlement intérieur) - l’égalité de chance à tous les élèves; - l’élection du comité de classe et de l’établissement; - la liberté d’expression; - la laïcité et la mixité dans les classes; - la participation des élèves à l’organisation des activités culturelles et sportives; - la participation des élèves à l’élaboration du règlement intérieur … -la culture des valeurs démocratiques telles que le respect de soi, des autres, des institutions et les symboles de la république; la solidarité et le travail"
            },
            {
              "titre": "2. L’élection du comité de classe",
              "contenu": "Définition On appelle comité de classe, une instance (équipe) formée par les élèves de la même classe qui dirige la classe et à la tête de laquelle se trouve le major Processus d’élection du comité de classe :la mise en scène L’enseignant prépare la classe en expliquant aux apprenants le but de cette mise en scène. Il s’agit de vivre et d’appliquer les principes démocratiques à l’école comme cela doit se faire dans la société notamment le respect des libertés, le respect du code électoral, la règle de majorité lors des élections, le respect de la vérité des urnes. Les différentes étapes de l’élection du comité de classe sont: Préparation et disposition du code électoral, du matériel et du mobilier à utiliser L’enseignant prépare à l’avance un code électoral simple, clair et concis à l’endroit des élèves. Il prendra soin aussi avec les apprenants de préparer les bulletins, l’urne, le comité de vigilance et aussi la disposition de la salle pour la circonstance. Il peut, si c’est possible inviter des collègues ou le responsable de l’établissement. Il doit prendre soin de proposer une durée à chaque activité. Choix et installation du comité électoral: le président et les deux rapporteurs Le mieux serait de contacter à l’avance les membres du présidium et de les briefer sur leur responsabilité afin d’éviter le cafouillage au jour dit. Lecture du code électoral par le président Le président ou un des rapporteurs à qui il aura donné l’autorisation, lit le code électoral. Ouverture des candidatures Le président annonce l’ouverture des candidatures. Pour une bonne gestion du temps, on limitera les candidatures à quatre (4) : deux candidatures volontaires et deux propositions. Chaque candidat devra confirmer chaque candidature. Ouverture de la campagne électorale Le président annonce l’ordre de passage de chaque candidat et le temps imparti à chacun. Les candidats battent à tour de rôle chacun selon une durée déterminée à l’avance. Chaque candidat peut se constituer un petit état-major pour préparer son texte de campagne. La classe, pour encourager les candidats applaudit avant et après la délivrance du message. Disposition du matériel de vote et distribution du bulletin de vote : Le comité de vigilance procède à la distribution des bulletins de vote aux apprenants. A défaut des bulletins de vote, utiliser les bouts de papier Le vote proprement dit Un petit temps est donner aux votants de choisir chacun son candidat. Chaque apprenant accomplira son devoir civique en respectant les consignes. Le dépouillement ou le comptage des votes A la fin du vote le comité procède au comptage des bulletins, puis au dépouillement public. Les résultats du dépouillement sont affichés au tableau. La proclamation des résultats Le président proclame les résultats et annonce le nom du vainqueur qui est acclamé. Les remerciements Les candidats malheureux félicitent le vainqueur et vice-versa Le président du présidium prend la parole en dernière position : il remercie tout le monde pour la bonne organisation, pour le bon déroulement du scrutin, pour le respect des principes démocratiques. Il déclare la fin de la mission du présidium et rend son tablier. L’Installation du comité de classe NB: On retient seulement les grandes lignes des étapes de l’élection du comité de classe (les commentaires c’est pour les explications)"
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. La police des examens",
              "contenu": "Définition La police des examens est l’ensemble des dispositions prises pour le bon déroulement des examens, des devoirs, des compositions et des concours. C’est aussi un document qui régit l’organisation et la mise en œuvre des compositions, examens et concours. Importance de la police d’examen La police des examens : - donne une égalité de chance aux candidats; - dissuade de la fraude (la tricherie); - assure la sécurité des candidats; - donne de la fiabilité et de la crédibilité aux diplômes délivrés; - permet de cultiver l’honnêteté."
            },
            {
              "titre": "2. Les dispositions de la police des examens",
              "contenu": "Dispositions générales Elles sont purement administratives et n’engagent pas les élèves. 2- 2- Dispositions relatives à la discipline Ce sont: - l’interdiction du port du portable, des documents non autorisés; - l’accès à la salle d’examen subordonné à la présentation d’une carte (scolaire ou carte nationale d’identité); - l’interdiction de toute communication entre les candidats ou entre les candidats et les surveillants; - l’accès à la salle d’examen est refusé à tout candidat en retard de quinze minutes (15minutes) et la note zéro (0) lui est attribuée pour la matière ratée. - etc. 2- 3- Dispositions relatives aux fraudes Pendant l’examen, sont considérés comme cas de fraudes : - toute communication pendant les épreuves; - l’introduction des documents non autorisés; - toute falsification ou usurpation d’identité; - etc. Toute fraude entraîne l’exclusion du candidat. Aussi tout surveillant ou membre de la commission d’examen surpris en flagrant délit d’irrégularités graves, sera exclu du centre d’examen en attendant d’autres sanctions."
            },
            {
              "titre": "3. Comportements de l’élève vis-à-vis de la police des examens",
              "contenu": "L’élève doit : - respecter toutes les dispositions de la police des examens; - présenter sa carte avant d’accéder à la salle; - éviter de communiquer avec les autres candidats une fois en salle; - s’assurer de ne pas être porteur de documents compromettants, notamment le téléphone portable, les émetteurs-récepteurs, les calculatrices programmables, les objets dangereux, les feuilles de papiers de toute nature, les cahiers, les livres; - occuper la place correspondante à son numéro de table; - accepter d’être fouillé avant d’entrer en salle; - etc."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définition",
              "contenu": "La Constitution est la loi fondamentale d’un Etat. NB : La constitution d’un Etat n’est pas stable, elle peut être objet d’une révision ou d’une modification. Une nouvelle constitution est adoptée suite à un vote référendaire dont le « Oui » l’emporte sur le « Non ». Ainsi, lorsqu’on adopte une nouvelle constitution, on passe à une nouvelle république."
            },
            {
              "titre": "2. Les différentes constitutions togolaises",
              "contenu": "Depuis son indépendance le 27 avril 1960 jusqu’à nos jours, le Togo a connu quatre (4) différentes constitutions qui sont résumés dans le tableau ci-dessous."
            },
            {
              "titre": "3. Présentation de la constitution de la cinquième république",
              "contenu": "La constitution togolaise de la Vième République du Togo a été adoptée par voie parlementaire (par les députés) le 19 Avril 2024 et promulguée le 6 Mai 2024 par le président Faure Essozimna GNASSINGBE.. Elle comporte un (1) préambule, 8 chapitres, 6 titres, 100 articles et une annexe de 25 articles. Cette constitution instaure un régime parlementaire et supprime l’élection présidentielle au suffrage universel direct. Avec cette nouvelle constitution le Togo sera dirigé par un Président de la République élu en congrès ( parlement+ Sénat) pour un mandat de 4 ans renouvelable une fois et un président du conseil choisi au sein du parti majoritaire à l’Assemblée Nationale pour un mandat de 6 ans. Cette nouvelle constitution supprime la cour suprême et remplace le médiateur de la république par un protecteur du citoyen. Enfin elle met en place un sénat composé de 61 sénateurs dont 41 élus par les conseillers municipaux et régionaux et 20 Nommés par le président du conseil. Les principes de la constitution togolaise sont: la protection divine; l’Etat de droit; le pluralisme politique; les principes de la démocratie; les principes de la protection des droits de l’homme; les principes d’égalité, de respect mutuel et de la souveraineté. Ses valeurs sont: le travail (bâtir); la liberté; la dignité; la patrie (la volonté de combattre tout régime politique fondé sur l’injustice, l’arbitraire, la dictature); la coopération; la paix; l’amitié; la solidarité; l’unité."
            },
            {
              "titre": "4. Importance de la constitution",
              "contenu": "La constitution: - indique les règles à partir desquelles s’organisent les relations entre l’Etat, les citoyens et les institutions; - garantit l’Etat de droit, - garantit aussi les droits et libertés des citoyens; - détermine l’organisation des pouvoirs publics; - contribue à éviter le désordre, l’arbitraire et l’anarchie; - constitue un gage de paix sociopolitique; - etc."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Notion de la hiérarchie des normes",
              "contenu": "- Une norme est une règle à laquelle tout citoyen doit se conformer. C’est aussi l’ensemble des règles de conduite qu’il convient de suivre au sein d’un groupe. - La hiérarchie des normes est le classement hiérarchisé de l’ensemble des normes composant le système juridique d’un Etat de droit. C’est aussi un principe qui détermine l’importance et la place de l’ensemble des normes qui régissent un pays. NB: Les normes sont hiérarchisées pour garantir la cohérence, la rigueur et l’impartialité."
            },
            {
              "titre": "2. Le principe de la hiérarchie des normes",
              "contenu": "La hiérarchie des normes est fondée sur le principe qu’une norme inférieure doit respecter celle du niveau supérieur. Exemple : L’arrêté doit être conforme au décret; le décret doit être conforme à l’ordonnance; l’ordonnance doit être conforme à la loi suprême qu’est la constitution. NB : Au sein d’une même catégorie, les normes juridiques sont ordonnées en respectant l’antériorité de la date. Exemple : - Vu le décret N°67-22 du 26 janvier 1967 - Vu le décret N°69-113 du 28 mai 1969 - Vu l’arrêté N°019/MEN-RS/METFP du 12 avril 1976 - Vu l’arrêté N°087/MEPSA/CAB/SG du 26 août 2010 Le schéma de la hiérarchie des normes"
            }
          ],
      ...
      },
      {
        ...
        "competence": "Respecter les normes et les lois de la République",
        "theme": "Décentralisation au Togo",
        "titre": "Juxtaposition des territorialités et répartition des compétences",
        "seances": 4,
        "fiche": {
          "competence": "Respecter les normes et les lois de la République",
          "theme": "Décentralisation au Togo",
          ...
          "resumeStructure": [
            {
              "titre": "1. Notion de territorialité",
              "contenu": "La territorialité exprime le sentiment d'appartenance à un territoire; c'est aussi l'ensemble des lois qui s'exercent sur les habitants d'une collectivité territoriale. Au Togo, on distingue deux types de collectivités territoriales : la commune et la région."
            },
            {
              "titre": "2. La juxtaposition des territorialités",
              "contenu": "C'est le fait que des territorialités organisées en collectivités territoriales soient l'une à côté de l'autre; cela désigne aussi la coexistence de plusieurs niveaux d'autorité sur un même territoire (par exemple une commune à l'intérieur d'une région)."
            },
            {
              "titre": "3. Les compétences propres des communes",
              "contenu": "Les communes exercent seules certaines compétences : lotissement, création et gestion des gares routières, des marchés et abattoirs locaux, signalisation routière, gestion du domaine foncier communal, protection des zones de maraîchage et d'élevage, création et entretien des forêts communales."
            },
            {
              "titre": "4. Les compétences relevant de l'État",
              "contenu": "Certaines compétences (défense nationale, diplomatie, monnaie, justice, grands travaux d'infrastructure nationale) relèvent uniquement de l'État et ne peuvent être exercées par les collectivités territoriales."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définitions",
              "contenu": "Le droit de suffrage universel est un vote dans lequel tous les citoyens ayant atteint un certain âge et jouissant de leurs droits civiques sont électeurs et éligibles. L'élection est l'action de choisir une personne par le vote pour occuper une fonction publique. Le référendum est un vote direct par lequel le peuple répond par oui ou par non à une question, notamment pour approuver ou rejeter une constitution ou une loi. Le code électoral est le document qui définit les règles applicables aux consultations électorales et référendaires."
            },
            {
              "titre": "2. Le rôle du code électoral",
              "contenu": "Au Togo, le code électoral est régi par la loi n° 2012-002. Il garantit des élections transparentes, justes et équitables; il permet à chaque citoyen d'exercer son droit et son devoir de participer à la gestion des affaires publiques; il empêche le double vote et établit les conditions d'éligibilité."
            },
            {
              "titre": "3. Les différentes élections au Togo",
              "contenu": "On distingue notamment l'élection présidentielle, les élections législatives (Assemblée nationale), les élections sénatoriales (Sénat, depuis la réforme de 2024), ainsi que les élections locales (municipales et régionales)."
            },
            {
              "titre": "4. Le déroulement d'un vote",
              "contenu": "L'électeur remet sa carte d'électeur pour vérification d'identité, reçoit un bulletin de vote, entre dans l'isoloir pour faire son choix en toute confidentialité, dépose son bulletin dans l'urne, puis trempe son index gauche dans l'encre indélébile pour attester qu'il a voté."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définition de médias",
              "contenu": "Les médias ou mass médias, sont des moyens qui permettent une diffusion large et collective de l’information. Les médias sont aussi, un ensemble de supports de diffusion massive de l’information."
            },
            {
              "titre": "2. Les principaux médias",
              "contenu": "Les différents types de médias sont : radio, télévision et cinéma, la presse écrite, affichage, internet…. Quelques médias au Togo sont : - Médias officiels ou publics : TVT, Radio Lomé, Radio Kara, Togo-presse… - Medias privés: Kanal FM, Radio Maria Togo, Pyramide FM, Taxi FM, Zéphyr FM, RTDS, TV2, TV7, TV ZION, New World TV, Espoir 47, www.alome.com... - les médias internationaux : RFI, France 24, TV5 Monde, Canal +,"
            },
            {
              "titre": "3. Les caractéristiques des médias en démocratie",
              "contenu": "En démocratie, les médias sont caractérisés par : - l’indépendance : ne subir aucune influence de la part des ONG, politiciens, syndicats; - l’impartialité : éviter de parti pris c’est-à-dire la propagande ou le combat; - la liberté : pas de censure (être libre dans le traitement des informations); - la crédibilité : vérifier les informations avant de les diffuser; - l’intégrité : respect de la déontologie du métier c’est-à-dire faire preuve du professionnalisme dans le travail; - la diversité : toucher toutes les couches de la société ou disposer de plusieurs sources d’informations."
            },
            {
              "titre": "4. Rôle des médias en démocratie",
              "contenu": "Les médias jouent un rôle clef dans le processus démocratique, car ils sont appelés à: - rechercher et à communiquer les informations; - sensibiliser le public; - inciter aux bonnes pratiques démocratiques (lorsque les médias dénoncent le déficit démocratique, la mauvaise gouvernance sous toutes ses formes, félicitent les bonnes actions, cela incite les gouvernants, les patrons d’entreprises ou de sociétés aux bonnes pratiques démocratiques); - animer les émissions et débats; - critiquer l’action du gouvernement et des acteurs politiques; - couvrir les campagnes électorales; - donner l’alerte sur les situations ou problèmes qui peuvent conduire à une crise ou à un conflit; - etc. L’Etat togolais a mis en place une institution qui veille sur les médias : c’est la Haute Autorité de l’Audiovisuel et la Communication (HAAC). Son actuel président est Willibrond Pitalounani TELOU. Dans la constitution de la cinquième république, la HAAC est devient HARC."
            },
            {
              "titre": "5. Rôle des médias dans la lutte contre l’extrémisme violent",
              "contenu": "L’extrémisme violent est une idéologie radicale qui prône l’utilisation de la violence pour atteindre des objectifs politique, religieux ou idéologiques. Dans la lutte contre l’extrémisme violent, les médias ont pour rôle de : Dénoncer les messages haineux et les appels à la violence; Appeler les populations au discernement; Promouvoir les valeurs sociales (solidarité, tolérance, justice, …); Éduquer à la citoyenneté numérique; Prévenir la radicalisation en ligne par la surveillance des contenus; Inciter à la bonne gouvernance, …."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définitions",
              "contenu": "- Les TIC signifient Technologie de l’Information et de la Communication. Ils désignent l’ensemble des technologies permettant de traiter des informations numériques et de les transmettre. - Le réseau social se définit comme des services en ligne ayant pour but de tisser des liens entre des personnes partageant des intérêts communs. - Un site internet ou site web est l’ensemble des pages web et des ressources inter reliées entre elles par des liens hypertextes, auxquelles l’internaute peut accéder par une adresse web."
            },
            {
              "titre": "2. Dangers liés aux réseaux sociaux et aux sites non recommandables",
              "contenu": "Les réseaux sociaux les plus utilisés sont : WhatsApp, Facebook, Tiktok; Instagram, twitter, telegram La mauvaise utilisation des réseaux sociaux peut créer des dangers à l’utilisateur. Nous pouvons citer entre autres : la cyberdépendance, le cyberharcèlement (menaces, envoi de photos obscènes et choquantes), la cybercriminalité, la fatigue oculaire ou visuelle, les troubles de sommeil dues aux images pornographiques, les fausses informations, etc. Certains sites ne sont pas recommandés aux jeunes car ils véhiculent des images, vidéos dangereuses comme la pornographie, la violence ou l’extrémisme religieux… Notion de moteurs de recherche Définition d’un moteur de recherches Un moteur de recherches est un logiciel qui permet de trouver l’information recherchée en ligne à l’aide de mots ou de phrases. Les moteurs de recherche les plus populaires sont Google, Yahoo, YouTube, Wikipédia. Utilisation des moteurs de recherches dans les études Les moteurs de recherche peuvent permettre aux élèves de : - faire de diverses recherches sur les leçons; - enrichir leurs connaissances dans divers domaines, - se faire former à distance; - trouver des bourses d’étude; - créer des groupes de travail en ligne; etc."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Importance de la formation professionnelle",
              "contenu": "Définition La formation professionnelle est une formation qui offre la possibilité à une personne d’acquérir les compétences spécifiques afin d’exercer un métier. C’est aussi, un ensemble d’enseignements techniques et professionnels qui ont pour but de former des hommes qualifiés, des techniciens, des ingénieurs. NB: La formation professionnelle peut s’organiser selon trois (3) modalités: la formation en présentiel, la formation à distance (e-learning) et la formation mixte. Importance La formation professionnelle permet à un jeune de: - acceder rapidement au marché du travail; - se mettre aussi facilement à son propre compte; - trouver une activité professionnelle; - passer rapidement de la théorie à la pratique; - avoir accès directement à une passion ou à un intérêt; - exercer un métier qui correspond à ses centres d’intérêt; - exceller dans ce qu’il aime; - retrouver sa motivation pour quelqu’un qui veut décrocher; - faire un stage en milieu de travail; etc."
            },
            {
              "titre": "2. Les centres et écoles de formation au Togo",
              "contenu": "Les centres de formation professionnelle au Togo Ce sont: - les Centres Régionaux d’Enseignement Technique et de Formation Professionnelle(CRETFP) de Kpalimé, Lomé, de Kara, Dapaong; - les Centres de Formation Technique Professionnel (CFTP) de Gamè, Tchamba; -le Centre d’Enseignement Artisanal et Artistique (CEAA) de Kpalimé; - le Centre de Formation au Métier des Industries (CFMI) à Lomé; - etc. Les écoles de formation professionnelle au Togo Ce sont: - les Collèges d’Enseignement Technique (CET): de Kévé, Kpélé-Govié, Sodo, Blitta, Pya, Pagouda,Bafilo, Bassar, Gando; etc. - les Lycées d’Enseignement Technique et Professionnel (LETP) de Adidogomé, Attiégou, Sokodé, Mango et Kanté; etc. - les écoles universitaires de formation des ingénieurs: ESA (Ecole Supérieure d’Agronomie), ENSI (Ecole Nationale Supérieure des Ingénieurs), ESTEBA (Ecole Supérieure des Techniques Biologiques et Alimentaires); etc. - les écoles de formation (qui ne sont pas dans le domaine technique mais qui forment des professionnels) : ENFPE ex-ENI (Ecole Normale de Formation des Professeurs d’Ecole), ENS (Ecole Normale Supérieure), ENSF (Ecole Nationale des Sages-Femmes), ENAM (Ecole Nationale des Auxiliaires Médicaux), ENAS (Ecole Nationale des Aides de Sanitaires) de Sokodé; etc."
            }
          ],
          ...
          "resumeStructure": [
            {
              ...
              "contenu": "Le genre est une notion qui décrit la répartition des fonctions sociales entre les hommes et les femmes. C’est aussi, l’ensemble des rapports sociaux entre garçon et fille"
            },
            {
              "titre": "2. Les causes des inégalités entre garçon et fille",
              "contenu": "Elles s’expliquent par : - l’inégalité d’accès au marché du travail en défaveur de la femme; - le système économique injuste et sexiste qui confirme la femme dans les métiers moins valorisés; - le poids de la tradition qui relègue la femme au second plan; - la discrimination envers la femme à cause des stéréotypes; - les violences subies par les femmes dans la sphère professionnelle ou privée; - la considération de l’homme comme le chef de famille; - etc."
            },
            {
              "titre": "3. Les actions qui promeuvent l’égalité entre garçon et fille",
              "contenu": "Les actions qui font la promotion de l’égalité entre garçon et fille sont : - la scolarisation de la fille et du garçon; - la répartition équitable des tâches à la maison; - la mixité des filières et des métiers; - l’encouragement des filles à prendre la parole en classe et en public; - la répartition équitable des tâches et responsabilités à l’école; - l’égalité de genre; - la non-discrimination entre les sexes; etc."
            },
            {
              "titre": "4. Les avantages de l’équité et de l’égalité entre fille et garçon dans le développement s",
              "contenu": "L’égalité et l’équité entre les hommes et les femmes ne signifient pas que les hommes et les femmes deviennent identiques, mais qu’ils aient des possibilités et des chances égales dans la société. Ainsi, elles permettent : - une égalité de chance entre fille et garçon - un développement harmonieux du pays, - une juste rémunération du travail de la femme, -aux femmes d’avoir plus d’accès aux postes de responsabilités, - l’atténuation des discriminations - une juste répartition des tâches et des dépenses de responsabilités, - un meilleur suivi de la société des enfants, etc."
            }
          ],
      ...
      },
      {
        ...
        "fiche": {
          ...
          "resumeStructure": [
            {
              "titre": "1. Définition de catastrophe naturelle",
              "contenu": "Une catastrophe naturelle est un évènement naturel brutal pouvant entrainer de lourds dégâts et la mort. Les exemples de catastrophes naturelles sont: les tempêtes, les éruptions volcaniques, les tremblements de terre, les inondations, les sécheresses, les incendies, les feux de brousse, les éboulements, les ouragans, les cyclones, etc. NB :Exemples de quelques catastrophes naturelles au Togo: - Tous les ans, le Togo connaît des feux de brousse et des vents violents; - Depuis 1967, l’érosion côtière a emporté deux fois de suite la route nationale n°2 (Lomé-Anèho); - En Juin 2022, les inondations ont entraîné la mort d’une personne dans la préfecture du Moyen-Mono et une autre dans la préfecture du Haho. - En Juin 2023, les inondations ont fait déplacés les populations de plusieurs villes togolaises particulièrement celles des préfectures du Golfe et d’Agoè-Nyivé."
            },
            {
              "titre": "2. Les principales causes des catastrophes naturelles",
              "contenu": "Ce sont: - Les causes naturelles: la pollution de l’air et de l’eau, les mouvements tectoniques, les processus naturels indépendants de la volonté de l’homme, etc. - Les causes anthropiques: la déforestation, l’extration du sable marin, l’urbanisation mal réfléchie, les constructions dans les zones à risque (dans les bas-fonds, les flancs de montagnes), l’utilisation des Gaz à Effet de Serre (GES), le manque de civisme, etc."
            },
            {
              "titre": "3. Les manifestations des catastrophes naturelles",
              "contenu": "Les manifestations dépendent de chaque catastrophe naturelle: - la terre qui tremble faisant tout s’écrouler; - le vent soufflant très fort emportant tout sur son passage; - l’eau qui monte envahissant les maisons et les rues; - le feu qui bembrasse la végétation, les maisons, les buldinds; - les vagues de l’océan qui se déversent sur les régions côtières emportant tout sur son passage; - des masses de boue ou de neige dévalant la montagne et rasant tout au pied de la montagne; - très forte chaleur le jour et la nuit pendant plusieurs jours; - les laves dévalant les flancs du volcan réduisant tout en poussière, ou bien des cendres brulantes s’étalant sur la ville ou sur la région; - etc."
            },
            {
              "titre": "4. Les conséquences des catastrophes naturelles",
              "contenu": "Ce sont: - les pertes en vies humaines; - les dégâts matériels/ destruction des ponts, routes, industries, etc.; - la pollution des eaux et des sols; - la prolifération des maladies diarrhéiques (choléra); - la dégradation de l’environnement; - la désolation dans la population; - les mutilations physiologiques; - les déplacements de la population; - les traumatismes psychologiques; - etc."
            }
          ],
      ...
      },
      {
        ...
        "competence": "Participer à la prévention et à la gestion des catastrophes naturelles",
        "theme": "Risques de catastrophes naturelles",
        "titre": "Prévention et gestion des catastrophes naturelles",
        "seances": 2,
        "fiche": {
          "competence": "Participer à la prévention et à la gestion des catastrophes naturelles",
          "theme": "Risques de catastrophes naturelles",
          ...
          "resumeStructure": [
            {
              "titre": "1. Les services de l’Etat intervenant dans la réduction des risques de catastrophes nature",
              "contenu": "Ce sont: - L’Agence Nationale de Protection Civile (ANPC), - La Direction des Ressources en Eau (DRE), - La Direction Générale de la Météorologie Nationale (DGMN) - La Direction de l’Environnement (DE) - L’Agence Nationale de Gestion de l’Environnemnt (ANGE) - L’Université de Lomé (UL) - La Direction des Statistiques Agricoles, de l’Information et de Documentation (DSID) - L’Institut National des Statistiques, des Etudes Economiques et Démographiques (INSEED) - Le Centre des Opérations des Urgences de Santé Publique (COUSP) - La Croix Rouge Togolaise (CRT) - Le Ministère de l’Environnement et des Ressources Forestières (MERF) - etc."
            },
            {
              "titre": "2. Les mesures de prévention des catastrophes naturelles: les systèmes d’alerte précoce (S",
              "contenu": "Pour prévenir efficacement les catastrophes naturelles, chaque pays met en place les Systèmes d’Alerte Précoce (SAP) appropriés aux catastrophes naturelles dont il est souvent victime. Ainsi au Togo, il y a le système d’alerte aux inondations. Ailleurs, il y a le système d’alerte aux feux de végétation; le système d’alerte aux séismes; le système d’alerte aux éruptions volcaniques; etc. Le système d’alerte comprend quatre (4) éléments qui sont: - la connaissance des risques en cours; - le suivi technique du service d’alerte, - la diffusion d’alertes compréhensibles à l’intention des personnes menacées; - la sensibilisation du public et la préparation à l’action."
            },
            {
              "titre": "3. Les bonnes pratiques en matière de gestion et de prévention des catastrophes naturelles",
              "contenu": "Les bonnes pratiques communautaires Ce sont: - le reboisement; - la mise en place des systèmes d’alerte précoces communautaires; - la réduction de l’émission des gaz à effet de serre; - la préparation des populations à la résilience à la survenue des catastrophes (éducation à la résilience, sécurisation des personnes et des biens, etc.) - l’éducation et sensibilisation des populations sur l’utilisation des gaz domestiques, etc. Les bonnes pratiques individuelles Ce sont: - le reboisement; - la pratique des feux de brousse précoce; - l’utilisation des gaz domestiques; - l’interdiction de jeter les ordures ou déchets dans les caniveaux et rues; etc."
            }
          ],
